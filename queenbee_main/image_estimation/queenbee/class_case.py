...
class Case():
    ...
    def __init__(self):
        ...
        self.setting_presen_time = 0
        self.writing_presen_time = 0
        self.presen_rest_time = 0
        self.ligsen_rest_time = 0
        self.judge_storage_maxtime = 0
        self.judge_storage_loop_time = 0
    ...
    def measure_time_up(self):
        ...
        while self.is_succeeded == False:
            while self.ALMOSTFINISHCASE == False or self.FINISHCASE == False:   
                time.sleep(5)
