        ...
        if os.path.exists(log_file):
            ...
            try:
                with open(log_file, mode="w") as f:
                    ...
                    writer.writerow(["Timeinfo","Level","Message", "Distance", "Relative Altitude", "Absolute Altitude", "Latitude", "Longitude","Landedstate"])
                    pass
...
def log_format(message = 'Nan', distance = 'Nan' ,
               relative_altitude = "Nan", absolute_altitude = "Nan", latitude = "Nan", longitude = "Nan", landedstate = "Nan"):
    return '{},{},{},{},{},{},{}'.format(message,distance, relative_altitude, absolute_altitude, latitude, longitude, landedstate)
