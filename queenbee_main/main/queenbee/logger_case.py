        ...
        if os.path.exists(log_file):
            ...
            try:
                with open(log_file, mode="w") as f:
                    ...
                    writer.writerow(["Timeinfo","Level","Message", "Light", "Pressure",  "Disp Pressure", "Light Counter", "Pressure Counter"])
                    pass
...
def log_format(message = np.nan, light = np.nan ,
               pressure = np.nan, disp_pressure = np.nan,  light_counter = np.nan, pressure_counter = np.nan):
    return '{},{},{},{},{},{}'.format(message, light, pressure, disp_pressure, light_counter, pressure_counter)
