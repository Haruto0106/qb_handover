        ...
        if os.path.exists(log_file):
            ...
            try:
                with open(log_file, mode="w") as f:
                    ...
                    writer.writerow(["Timeinfo","Level","Message", "Distance", "Relative Altitude", "Absolute Altitude", "Latitude", "Longitude"])
                    pass
...
def log_format(message = np.nan, distance = np.nan ,
    ...
    return '{},{},{},{},{},{}'.format(message,distance, relative_altitude, absolute_altitude, latitude, longitude)
